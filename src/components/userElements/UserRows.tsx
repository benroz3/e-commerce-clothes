        ...
        <PageTransition>
          <div className="flex items-center justify-center flex-col mt-10">
            <div className="max-w-screen-xl w-full">
              <div className="flex items-start justify-between ml-8 mt-3 border-b border-b-black w-[20%]">
                <input
                  type="text"
              ...
              <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="mt-5 flex flex-col">
                  <div className="flex items-center justify-between gap-3 mt-5 w-full bg-black rounded-t p-2">
                  ...
                  {filteredUsers &&
                    ...
                    filteredUsers.map((user) => (
                      <div
                        key={user._id}
                        className="flex items-center justify-between gap-3 w-full bg-gray-300 p-2"
                      >
